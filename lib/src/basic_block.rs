...
mod tests {
    ...
    fn construct() {
        ...
        let i1 = vec!(
            Statement::Operation{ op: Operation::Add(Rvalue::new_u8(1),Rvalue::new_u8(2)), assignee: Lvalue::Variable{ name: Cow::Borrowed("a"), size: 8, subscript: Some(2) }},
            Statement::Operation{ op: Operation::Add(Rvalue::new_u8(4),Rvalue::new_u8(2)), assignee: Lvalue::Variable{ name: Cow::Borrowed("a"), size: 8, subscript: Some(1) }},
            Statement::Operation{ op: Operation::Phi(vec!(
        ...
        bb.rewrite(|i| {
            *i = match &i.assignee {
                &Lvalue::Variable{ name: ref n, size: ref w, subscript: _ } =>
                    Statement::Operation{ op: i.op.clone(), assignee: Lvalue::Variable{ name: n.clone(), size: *w, subscript: None } },
                _ => i.clone()
            };
        });
